" Vim syntax file
" " Filename:     vcl.vim
" " Language:     Varnish configuation Language,
" http://www.varnish-cache.org/wiki/VCL
...
"     "       director NAME FLAGS {
"     "       acl NAME {
"     "syn region vclCodeBlock start="\s*\<sub\|backend\|director\|acl\>"
"     end="{"he=e-1 contains=vclCodeBlockName,vclFunctionName
...
"
"     " C strings
"     syn region vclString start=+L\="+ skip=+\\\\\|\\"+ end=+"+
"     contains=vclSpecial
...
"
"     " Numbers
"     syn match  vclNumbers  display transparent "\<\d\|\.\d"
"     contains=vclNumber,vclNumberTime
...
"     " req
"     syn match  vclOption
"     /req\.\(hash\|request\|url\|proto\|backend\.healthy\|backend\|grace\|xid\|restarts\)/
"     " bereq
"     syn match  vclOption
"     /bereq\.\(request\|url\|proto\|connect_timeout\|first_byte_timeout\|between_bytes_timeout\)/
"     " obj
"     syn match  vclOption
"     /obj\.\(proto\|status\|response\|cacheable\|ttl\|lastuse\|hits\|hash\|grace\|prefetch\)/
"     " beresp
"     syn match  vclOption
"     /beresp\.\(proto\|status\|response\|cacheable\|ttl\|lastuse\|hits\|hash\|grace\|prefetch\|saintmode\)/
"     " resp
"     syn match  vclOption   /resp\.\(proto\|status\|response\)/
"     " common: http.HEADERNAME
"     syn match  vclOption
"     /\(req\|bereq\|resp\|beresp\|obj\)\.http\.[A-Za-z][-_A-Za-z0-9]*/
"
...
"     syn region vclCBlock matchgroup=vclComment start=/C{/ end=/}C/
"     contains=@vclC keepend
"
"     " Synthetic
"     syn region vclSynthetic start=/{"/hs=s+2 end=/"}/he=e-2
"     contains=@vclHTML keepend
"
